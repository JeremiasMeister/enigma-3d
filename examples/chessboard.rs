...
fn initialize_board(app_state: &mut AppState, event_loop: &EventLoop) {
    ...
    // setup models
    let mut obj_board = Object::load_from_gltf_resource(example_resources::chess_board_gltf(), None);
    ...
    let mut obj_queen_white = Object::load_from_gltf_resource(example_resources::chess_queen_gltf(), None);
    ...
    let mut obj_knight_white_1 = Object::load_from_gltf_resource(example_resources::chess_knight_gltf(), None);
    ...
    let mut obj_rook_white_1 = Object::load_from_gltf_resource(example_resources::chess_rook_gltf(), None);
    ...
    let mut obj_pawn_white_1 = Object::load_from_gltf_resource(example_resources::chess_pawn_gltf(), None);
    ...
    let mut obj_bishop_black_1 = Object::load_from_gltf_resource(example_resources::chess_bishop_gltf(), None);
    ...
    let mut obj_queen_black = Object::load_from_gltf_resource(example_resources::chess_queen_gltf(), None);
    ...
    let mut obj_knight_black_1 = Object::load_from_gltf_resource(example_resources::chess_knight_gltf(), None);
    ...
    let mut obj_rook_black_1 = Object::load_from_gltf_resource(example_resources::chess_rook_gltf(), None);
    ...
    let mut obj_pawn_black_1 = Object::load_from_gltf_resource(example_resources::chess_pawn_gltf(), None);
...
fn initialize_knight(app_state: &mut AppState, event_loop: &EventLoop) {
    ...
    knight.transform.set_position([0.0,-1.85,-12.0]);
...
fn initialize_landscape(app_state: &mut AppState, event_loop: &EventLoop) {
    ...
    let mut obj_terrain = object::Object::load_from_gltf_resource(example_resources::terrain(), None);
    obj_terrain.set_name("obj_terrain".to_string());
    obj_terrain.set_collision(false);
    obj_terrain.add_material(ground_material.uuid);
    obj_terrain.transform.set_position([0.0, -1.8, -6.0]);
    obj_terrain.transform.set_rotation([0.0, -70.0, 0.0]);

    let mut obj_tree = object::Object::load_from_gltf_resource(example_resources::tree(), None);
    ...
    obj_tree.transform.set_position([-5.0, -1.8, -10.0]);
